...
| :--- | :--- | :---: | :---: | :---: |
| Início | `index.html` | Sim | Sim | ✅ OK |
| Blog/Notícias | `noticias/index.html` | Sim | Sim | ✅ OK |
| Comparar | `comparar/index.html` | Não | Sim | ✅ OK |
| Marcas | `marcas/index.html` | Sim | Sim | ✅ OK |
| Glossário | `glossario/index.html` | Não | Sim | ✅ OK |
| Alertas | `alertas/index.html` | Não | Sim | ✅ OK |
| Quedas Hoje | `quedas-hoje/index.html` | Não | Sim | ✅ OK |
| Vale a Pena Esperar | `vale-a-pena-esperar/index.html` | Não | Sim | ✅ OK |
| Mais Clicados | `mais-clicados/index.html` | Não | Sim | ✅ OK |
